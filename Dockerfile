...
RUN mvn dependency:get -Dartifact=org.apache.hadoop:hadoop-client-api:3.4.1
RUN mvn dependency:get -Dartifact=org.apache.hadoop:hadoop-hdfs:3.4.1
RUN mvn dependency:get -Dartifact=org.apache.hadoop:hadoop-mapreduce-client-core:3.4.1
